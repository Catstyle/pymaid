 ...
 * @record
 */
proto.complicated.Message.ObjectFormat = function() {
  /** @type {?|undefined} */
  this.message;
};
 ...
 * @param {!proto.complicated.Message.ObjectFormat} obj
...
/**
 * @param {string} value
 * @return {!proto.complicated.Message} returns this
 */
...
proto.complicated.ComplicatedMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    uintsList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f,
...
/**
 * The raw object form of ComplicatedMessage as accepted by the `fromObject` method.
 * @record
 */
proto.complicated.ComplicatedMessage.ObjectFormat = function() {
  /** @type {?|undefined} */
  this.message;
...
/**
 * Loads data from an object into a new instance of this proto.
 * @param {!proto.complicated.ComplicatedMessage.ObjectFormat} obj
 *     The object representation of this proto to load the data from.
...
proto.complicated.ComplicatedMessage.fromObject = function(obj) {
  ...
  obj.uintsList != null && jspb.Message.setField(msg, 2, obj.uintsList);
  obj.messagesMap && jspb.Message.setWrapperField(
  ...
  while (reader.nextField()) {
    ...
    case 2:
      ...
      for (var i = 0; i < values.length; i++) {
        msg.addUints(values[i]);
      }
      break;
    case 3:
      var value = msg.getMessagesMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readUint32, jspb.BinaryReader.prototype.readMessage, proto.complicated.Message.deserializeBinaryFromReader, 0, new proto.complicated.Message());
         });
      break;
    case 4:
 ...
 * @return {!proto.complicated.ComplicatedMessage} returns this
*/
